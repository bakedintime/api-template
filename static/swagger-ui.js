...
function program11(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n          ";
  stack1 = helpers['if'].call(depth0, depth0.responseMes***REMOVED***ges, {hash:{},inverse:self.noop,fn:self.program(7, program7, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n          ";
...
(function() {
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.render = function() {
      ...
      _ref7 = this.model.responseMes***REMOVED***ges;
